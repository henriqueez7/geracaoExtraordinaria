...
export default function Carrosel() {
  ...
  return (
    <section className={styles.carroselSection}>
      <h2 className={styles.title}>GERAÇÃO EXTRAORDINÁRIA</h2>
      ...
      <div className={styles.navigationControls}>
        <div ref={navigationPrevRef} className={styles.prevButton}>
          &#10094;
        </div>
        <div ref={paginationRef} className={styles.pagination}></div>
        <div ref={navigationNextRef} className={styles.nextButton}>
          &#10095;
        </div>
      </div>
